/**
 * Stream CORS proxy — Cloudflare Worker
 *
 * A literal port of netlify/functions/proxy.ts. Receives a request, reads
 * the upstream target from ?url=, strips hop-by-hop headers, forwards the
